...
public class RMILightBulbImpl
    ...
    public RMILightBulbImpl(HashMap<String, User> clients) throws RemoteException {
    ...
    public void sendMessage(String s, String username) throws RemoteException {
         System.out.println("Receive message from " + username + ": " + s);
    }
